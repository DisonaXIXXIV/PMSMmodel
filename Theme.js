...
const DARK_PALETTE = {
  ...
  // Карточка темы: панель разложена на «Машину», «Режим управления»,
  // «Параметры режима» и «Визуализацию», и каждая тема стоит на своей подложке.
  cardSurface: [28, 34, 45],
  cardBorder: [43, 52, 68],
  statusCard: [28, 35, 47],
  ...
  // Выбор режима. Тёмно-синий против голубого у остальных органов: по цвету
  // видно, что эта кнопка меняет поведение привода, а не число в нём.
  modeSurface: [24, 33, 50],
  modeBorder: [45, 60, 88],
  modeTrack: [17, 23, 35],
  modeAccent: [52, 92, 178],
  modeLabel: [172, 187, 209],
  modeLabelSelected: [244, 248, 253],
...
const LIGHT_PALETTE = {
  ...
  cardSurface: [250, 251, 253],
  cardBorder: [219, 226, 237],
  ...
  modeSurface: [228, 236, 248],
  modeBorder: [201, 214, 235],
  modeTrack: [212, 223, 240],
  modeAccent: [30, 73, 150],
  modeLabel: [56, 70, 92],
  modeLabelSelected: [255, 255, 255],
