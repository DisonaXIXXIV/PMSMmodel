...
// Значения паспорта по умолчанию для тех трёх величин, которые меняются из
...
// Паспорт машины. Три величины — сопротивление обмотки, её индуктивность и
// момент инерции — настраиваются из панели: именно от них зависят постоянные
// времени, которые и показывает модель. Всё остальное здесь зафиксировано в
...
class MotorParameters {
  ...
  // сбросом наравне с resetGuiParametersPreservingMode: раз эти три величины
